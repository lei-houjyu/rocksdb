...
SyncServiceImpl::SyncServiceImpl(rocksdb::DB* db)
...
Status SyncServiceImpl::Sync(ServerContext* context, 
...
void SyncServiceImpl::HandleSyncRequest(const SyncRequest* request, 
                          SyncReply* reply) {
    log_apply_counter_++;
...
void SyncServiceImpl::ResetStates(){
...
rocksdb::VersionEdit SyncServiceImpl::ParseJsonStringToVersionEdit(const json& j_edit /* json version edit */){
...
rocksdb::IOStatus SyncServiceImpl::CreateSstPool(){
 ...
 * 
 */
rocksdb::IOStatus SyncServiceImpl::UpdateSstBitMapAndShipSstFiles(const rocksdb::VersionEdit& edit){
...
void SyncServiceImpl::SetReplyMessage(SyncReply* reply){
